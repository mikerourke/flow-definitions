...
declare module 'redux-actions' {
   ...
   *
   */
  declare export function createAction<T, P>(
    type: T,
  ...
  declare export function createAction<T, A, P>(
    type: T,
    payloadCreator: (...rest: A) => P,
    $?: empty
  ): (...rest: A) => { type: T, payload: P, error?: boolean };

  declare export function createAction<T, P, M>(
    type: T,
  ...
  // use this one?
  declare export function createActions(actionMap: Object, ...identityActions: string[]): Object;
  declare export function createActions(...identityActions: string[]): Object;
   ...
   *     }, defaultState)
   */
  declare export function handleAction<Type, State, Action: { type: Type }>(
    type: Type,
    reducer: Reducer<State, Action> | ReducerMap<State, Action>,
    defaultState: State
  ): Reducer<State, Action>;

  declare export function handleActions<State, Action>(
    reducers: { [key: string]: Reducer<State, Action> | ReducerMap<State, Action> },
    defaultState?: State
  ): Reducer<State, Action>;

  declare export function combineActions(...types: (string | Symbol | Function)[]): string;
}
